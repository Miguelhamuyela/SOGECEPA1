                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/hospital_cabinda_1.jpeg"
                                    alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/hospital_cabinda_2.jpeg"
                                    alt="">
