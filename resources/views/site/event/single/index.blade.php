                    ...
                    <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-breadcrumbs-item gdlr-core-item-pdlr gdlr-core-item-pdb "> <span
                                ...
                                <meta property="position" content="1">
                                     ...
                                     href="{{ route('site.event') }}"
                                    class="post post-page"><span property="name">Eventos</span></a>
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <b style="color: #222;">Data:  </b> {{ date('d - m - Y', strtotime($events->dateEvent)) }}


                                        </div>

                                        <div class="col-12 col-md-4">
                                            <b style="color: #222;">Horário:  </b> {{$events->startTime}}h -  {{$events->endTime}}h
                    ...
                    <div class="container">
                        <div class="row ">
                                ...
                                <div class="col-lg-1 button-share-event">
                                    ...
                                    <a style="background: rgba(0,117,184,255);" class="p-3 text-white" target="_blank" class="fb-xfbml-parse-ignore">
