...
@section('titulo', ' Hospital Dr.Walter Strangway')
@section('content')
    <!-- ====== Banner Start ====== -->
            ...
            <div class="financity-page-title-wrap  financity-style-custom financity-left-align">
                ...
                <div class="financity-page-title-container financity-container">
                    <div class="financity-page-title-content financity-item-pdlr">
                        <h1 class="financity-page-title">Hospital Dr.Walter Strangway</h1>
                ...
                <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                    <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-breadcrumbs-item gdlr-core-item-pdlr gdlr-core-item-pdb "> <span
                            ...
                            •<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage"
                                    href="{{ route('site.instituteHematologic') }}" class="post post-page"><span
                                        property="name">Hospital Dr.Walter Strangway</span></a>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <p style="text-align: justify;">
                                ...
                                O Hospital Provincial Dr. Walter Strangway, na província do Bié, conta com mais de 20
                                serviços especializados,
                                com destaque para Gineco-obstetrícia, Pediatria, Neonatologia, Cirurgia, Nefrologia,
                                Oftalmologia, Ortopedia,
                                Psiquiatria, Estomatologia e Otorrinolaringologia.
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo"
                                    src="/site/assets/upload/hospital_stringWay_1.jpeg" alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo"
                                    src="/site/assets/upload/hospital_stringWay_2.jpeg" alt="">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo"
                                    src="/site/assets/upload/hospital_stringWay_3.jpeg" alt="">
